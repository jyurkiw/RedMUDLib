...
function AreaLib(client) {
    ...
    function setArea(areaCode, areaData, callback) {
        updateData = Object.assign({}, areaData);

        if (areaCode != updateData.areacode && typeof(updateData.areacode) != 'undefined') {
            if (typeof(callback) === 'function') {
                callback(false);
                return;
            }
        } else if (typeof(updateData.areacode) !== 'undefined') {
            delete updateData.areacode;
        } else if (typeof(updateData.size) !== 'undefined') {
        ...
        areaExists(areaCode, function(exists) {
            if (!exists) {
                ...
                client.hmset(codeutil.buildAreaCode(areaCode), updateData, function(err, res) {
                    if (err === null) {
                        if (typeof(callback) === 'function') {
    ...
    function setAreaAsync(areaCode, areaData) {
        ...
        return new Promise(function(resolve, reject) {
            if (typeof(updateData.areacode) !== 'undefined') {
